...
import static com.cleanup.todoc.utils.TestUtils.expectedItemCount;
...
import com.cleanup.todoc.utils.TestDatabaseCallback;
...
public class MainActivityInstrumentedTest {
    ...
    public void setup() {
        ...
        ApplicationDatabase.createInMemoryDatabase(context, new TestDatabaseCallback());
        this.rule.getScenario().onActivity(MainActivity::init);
    }

    @After
    public void tearDown() {

        ApplicationDatabase.getInstance().close();
    }
